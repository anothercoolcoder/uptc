...
public class GuiGestionClase {
    ...
    private void verCursosDisponibles() {
        System.out.println("\n--- CURSOS DISPONIBLES ---");
        String cursos = conversor.listarCursosDisponibles();
    ...
    private void registrarInstructor() {
        ...
        do {
            ...
            if (!tipo.equals("creador") && !tipo.equals("director")) {
                System.out.println("Error: El tipo debe ser 'creador' o 'director'");
            }
        } while (!tipo.equals("creador") && !tipo.equals("director"));
    ...
    private void menuInstructor(Instructor instructor) {
        ...
        do {
            ...
            System.out.println("2. Crear nuevo curso (solo directores)");
            System.out.println("3. Eliminar curso (solo directores)");
            System.out.println("4. Cambiar descripcion de curso (solo directores)");
            ...
            switch(opcion) {
                ...
                case 2:
                    if (instructor instanceof InstructorDirector) {
                        crearNuevoCurso((InstructorDirector) instructor);
                    } else {
                ...
                case 3:
                    if (instructor instanceof InstructorDirector) {
                        eliminarCurso((InstructorDirector) instructor);
                    } else {
                        System.out.println("Esta opción es solo para instructores directores");
                    }
                    break;
                case 4:
                    if(instructor instanceof InstructorDirector){
                      modificarDescripcionCurso((InstructorDirector)instructor);
                    }else{
                        System.out.println("Esta opción es solo para instructores directores");
                    }
                    break;
    ...
    private void crearNuevoCurso(InstructorDirector instructor) {
        System.out.println("\n--- CREAR NUEVO CURSO ---");
        System.out.print("Nombre del curso: ");
        String nombre = sc.nextLine();
        System.out.print("Descripción: ");
